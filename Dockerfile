...
ENTRYPOINT ["monerod"]
CMD ["--rpc-bind-ip=0.0.0.0", "--data-dir=/monero", "--rpc-ssl=enabled", "--restricted-rpc", "--public-node",  "--confirm-external-bind",  "--non-interactive", "--no-zmq", "--enforce-dns-checkpointing", "--log-level=1"]
